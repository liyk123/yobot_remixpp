...
// generated by ./sqlpp11-ddl2cpp yobotdata.sql yobotdata yobot::data
...
namespace data
{
  ...
  namespace User_
  {
    ...
    struct NotifyPreference
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "notify_preference";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T notifyPreference;
            T& operator()() { return notifyPreference; }
            const T& operator()() const { return notifyPreference; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::integer, sqlpp::tag::require_insert>;
    };
  ...
  namespace ClanGroup_
  {
    ...
    struct Level4
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "level_4";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T level4;
            T& operator()() { return level4; }
            const T& operator()() const { return level4; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::integer, sqlpp::tag::require_insert>;
    };
    ...
    struct BossHealth
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "boss_health";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T bossHealth;
            T& operator()() { return bossHealth; }
            const T& operator()() const { return bossHealth; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::integer, sqlpp::tag::require_insert>;
    };
    struct ChallengingMemberQqId
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "challenging_member_qq_id";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T challengingMemberQqId;
            T& operator()() { return challengingMemberQqId; }
            const T& operator()() const { return challengingMemberQqId; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::integer, sqlpp::tag::can_be_null>;
    };
    struct BossLockType
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "boss_lock_type";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T bossLockType;
            T& operator()() { return bossLockType; }
            const T& operator()() const { return bossLockType; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::integer, sqlpp::tag::require_insert>;
    };
    ...
    struct ChallengingComment
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "challenging_comment";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T challengingComment;
            T& operator()() { return challengingComment; }
            const T& operator()() const { return challengingComment; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::text, sqlpp::tag::can_be_null>;
    };
  ...
  struct ClanGroup: sqlpp::table_t<ClanGroup,
               ...
               ClanGroup_::BossNum,
               ClanGroup_::BossHealth,
               ClanGroup_::ChallengingMemberQqId,
               ClanGroup_::BossLockType,
               ClanGroup_::ChallengingStartTime,
               ClanGroup_::ChallengingComment,
               ClanGroup_::Deleted>
  {
    struct _alias_t
    {
  ...
  namespace ClanChallenge_
  {
    ...
    struct BossHealthRamain
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "boss_health_ramain";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T bossHealthRamain;
            T& operator()() { return bossHealthRamain; }
            const T& operator()() const { return bossHealthRamain; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::integer, sqlpp::tag::require_insert>;
    };
  ...
  struct ClanChallenge: sqlpp::table_t<ClanChallenge,
               ...
               ClanChallenge_::BossHealthRamain,
  ...
  namespace UserBox_
  {
    ...
    struct LastUse
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "last_use";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T lastUse;
            T& operator()() { return lastUse; }
            const T& operator()() const { return lastUse; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::integer, sqlpp::tag::require_insert>;
    };
    ...
    struct Stars
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "stars";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T stars;
            T& operator()() { return stars; }
            const T& operator()() const { return stars; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::integer, sqlpp::tag::require_insert>;
    };
    struct Equit
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "equit";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T equit;
            T& operator()() { return equit; }
            const T& operator()() const { return equit; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::integer, sqlpp::tag::require_insert>;
    };
  ...
  struct UserBox: sqlpp::table_t<UserBox,
               UserBox_::Qqid,
               UserBox_::Chid,
               UserBox_::LastUse,
               UserBox_::Rank,
               ...
               UserBox_::Equit>
  {
    struct _alias_t
    {
      static constexpr const char _literal[] =  "user_box";
      using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
      template<typename T>
      struct _member_t
      {
        T userBox;
        T& operator()() { return userBox; }
        const T& operator()() const { return userBox; }
      };
    };
  };
  namespace ClanSubscribe_
  {
    struct Sid
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "sid";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
    ...
    struct SubscribeItem
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "subscribe_item";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T subscribeItem;
            T& operator()() { return subscribeItem; }
            const T& operator()() const { return subscribeItem; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::integer, sqlpp::tag::require_insert>;
    };
  ...
  struct ClanSubscribe: sqlpp::table_t<ClanSubscribe,
               ClanSubscribe_::Sid,
               ClanSubscribe_::Gid,
               ClanSubscribe_::Qqid,
               ClanSubscribe_::SubscribeItem,
               ClanSubscribe_::Message,
               ClanSubscribe_::CreatedTime>
  {
    struct _alias_t
    {
      static constexpr const char _literal[] =  "clan_subscribe";
      using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
      template<typename T>
      struct _member_t
      {
        T clanSubscribe;
        T& operator()() { return clanSubscribe; }
        const T& operator()() const { return clanSubscribe; }
      };
    };
  };
} // namespace data
